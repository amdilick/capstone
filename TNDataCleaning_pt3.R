...
# convert numeric factors to descriptives for easier identification
# Beginning info: row count = 162454,  col count = 55
...
TN2019$Business_or_Commercial_Purpose <- sapply(TN2019$business_or_commercial_purpose,convert_business_purpose)
TN2019$Business_or_Commercial_Purpose <- as.factor(TN2019$Business_or_Commercial_Purpose)
