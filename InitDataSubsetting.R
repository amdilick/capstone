...
X2019publicTX <- subset(X2019publiclarcsv, state_code== 'TX')
write.csv(X2019publicTX, "X2019publicTX.csv", row.names = TRUE)
remove(X2019publicTX)
...
X2019publicTN <- subset(X2019publiclarcsv, state_code== 'TN')
write.csv(X2019publicTN, "X2019publicTN.csv", row.names = TRUE)
remove(X2019publicTN)
...
X2019publicLA <- subset(X2019publiclarcsv, state_code== 'LA')
write.csv(X2019publicLA, "X2019publicLA.csv", row.names = TRUE)
remove(X2019publicLA)
...
X2019publicNY <- subset(X2019publiclarcsv, state_code== 'NY')
write.csv(X2019publicNY, "X2019publicNY.csv", row.names = TRUE)
remove(X2019publicNY)
