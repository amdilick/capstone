...
TN2019_reg_X2 <- subset(TN2019_regression, select =c('Application_Status', 'derived_msa_md',
                                            'derived_loan_product_type', 'derived_ethnicity',
                                            'Applicant_Ethnicity', 'Co_Applicant_Ethnicity', 'derived_race', 'Applicant_Race', 
                                            'Co_Applicant_Race','derived_sex', 'Applicant_Sex', 'Co_Applicant_Sex','Combined_Applicant_Sex',
                                            'applicant_age', 'co_applicant_age', 'property_value', 'income', 'debt_to_income_ratio'))
...
TN2019_X2 <- chiSquare(TN2019_regression$Application_Status ~ TN2019_regression$derived_msa_md +
                          TN2019_regression$Lien_Status + TN2019_regression$Applicant_Race + 
                          ...
                          TN2019_regression$Combined_Applicant_Sex)  
print(TN2019_X2)
